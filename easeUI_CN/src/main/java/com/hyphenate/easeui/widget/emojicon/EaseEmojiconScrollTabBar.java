...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(com.hyphenate.easeui.R.layout.ease_widget_emojicon_tab_bar, this);
        
        scrollView = (HorizontalScrollView) findViewById(com.hyphenate.easeui.R.id.scroll_view);
        tabContainer = (LinearLayout) findViewById(com.hyphenate.easeui.R.id.tab_container);
    }
    ...
    public void addTab(int icon){
        View tabView = View.inflate(context, com.hyphenate.easeui.R.layout.ease_scroll_tab_item, null);
        ImageView imageView = (ImageView) tabView.findViewById(com.hyphenate.easeui.R.id.iv_icon);
    ...
    public void selectedTo(int position){
        ...
        for (int i = 0; i < tabList.size(); i++) {
            if (position == i) {
                tabList.get(i).setBackgroundColor(getResources().getColor(com.hyphenate.easeui.R.color.emojicon_tab_selected));
            } else {
                tabList.get(i).setBackgroundColor(getResources().getColor(com.hyphenate.easeui.R.color.emojicon_tab_nomal));
            }
        }
    }
