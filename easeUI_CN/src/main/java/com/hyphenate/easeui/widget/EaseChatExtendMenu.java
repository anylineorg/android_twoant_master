...
public class EaseChatExtendMenu extends GridView{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.hyphenate.easeui.R.styleable.EaseChatExtendMenu);
        int numColumns = ta.getInt(com.hyphenate.easeui.R.styleable.EaseChatExtendMenu_numColumns, 4);
        ta.recycle();
    ...
    class ChatMenuItem extends LinearLayout {
        ...
        private void init(Context context, AttributeSet attrs) {
            LayoutInflater.from(context).inflate(com.hyphenate.easeui.R.layout.ease_chat_menu_item, this);
            imageView = (ImageView) findViewById(com.hyphenate.easeui.R.id.image);
            textView = (TextView) findViewById(com.hyphenate.easeui.R.id.text);
        }
