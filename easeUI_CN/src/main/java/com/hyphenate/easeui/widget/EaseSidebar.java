...
public class EaseSidebar extends View{
	...
	private void init(){
	    String st = context.getString(com.hyphenate.easeui.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(com.hyphenate.easeui.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(com.hyphenate.easeui.R.drawable.ease_sidebar_background_pressed);
			return true;
		}
