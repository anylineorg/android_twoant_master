...
public class ChatRowRedPacket extends EaseChatRow {
    ...
    protected void onInflateView() {
        if (message.getBooleanAttribute(RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE, false)) {
            inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                    com.easemob.redpacketui.R.layout.em_row_received_red_packet : com.easemob.redpacketui.R.layout.em_row_sent_red_packet, this);
        }
    }

    @Override
    protected void onFindViewById() {
        mTvGreeting = (TextView) findViewById(com.easemob.redpacketui.R.id.tv_money_greeting);
        mTvSponsorName = (TextView) findViewById(com.easemob.redpacketui.R.id.tv_sponsor_name);
        mTvPacketType = (TextView) findViewById(com.easemob.redpacketui.R.id.tv_packet_type);
    }
    ...
    protected void onSetUpView() {
        ...
        if (!TextUtils.isEmpty(packetType) && TextUtils.equals(packetType, RedPacketConstant.GROUP_RED_PACKET_TYPE_EXCLUSIVE)) {
            ...
            mTvPacketType.setText(com.easemob.redpacketui.R.string.exclusive_red_packet);
        } else {
