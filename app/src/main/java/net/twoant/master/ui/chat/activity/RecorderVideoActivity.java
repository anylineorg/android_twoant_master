...
public class RecorderVideoActivity extends ChatBaseActivity implements
	...
	protected int getLayoutId() {
		return net.twoant.master.R.layout.em_recorder_activity;
	}
	...
	private void initViews() {
		btn_switch = (Button) findViewById(net.twoant.master.R.id.switch_btn);
		btn_switch.setOnClickListener(this);
		btn_switch.setVisibility(View.VISIBLE);
		mVideoView = (VideoView) findViewById(net.twoant.master.R.id.mVideoView);
		btnStart = (ImageView) findViewById(net.twoant.master.R.id.recorder_start);
		btnStop = (ImageView) findViewById(net.twoant.master.R.id.recorder_stop);
		btnStart.setOnClickListener(this);
		btnStop.setOnClickListener(this);
		mSurfaceHolder = mVideoView.getHolder();
		mSurfaceHolder.addCallback(this);
		mSurfaceHolder.setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
		chronometer = (Chronometer) findViewById(net.twoant.master.R.id.chronometer);
	}
	...
	public void onClick(View view) {
		switch (view.getId()) {
		case net.twoant.master.R.id.switch_btn:
			switchCamera();
			break;
		case net.twoant.master.R.id.recorder_start:
			// start recording
		    if(!startRecording())
		        return;
			Toast.makeText(this, net.twoant.master.R.string.The_video_to_start, Toast.LENGTH_SHORT).show();
			...
			chronometer.start();
			break;
		case net.twoant.master.R.id.recorder_stop:
			...
			new AlertDialog.Builder(this)
					.setMessage(net.twoant.master.R.string.Whether_to_send)
					.setPositiveButton(net.twoant.master.R.string.ok,
					...
					.setNegativeButton(net.twoant.master.R.string.cancel,
							new DialogInterface.OnClickListener() {
	...
	public void onInfo(MediaRecorder mr, int what, int extra) {
		...
		if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
			...
			String st3 = getResources().getString(net.twoant.master.R.string.Whether_to_send);
			new AlertDialog.Builder(this)
					.setMessage(st3)
					.setPositiveButton(net.twoant.master.R.string.ok,
							new DialogInterface.OnClickListener() {
							...
							}).setNegativeButton(net.twoant.master.R.string.cancel, null)
					.setCancelable(false).show();
		}
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this)
				.setTitle(net.twoant.master.R.string.prompt)
				.setMessage(net.twoant.master.R.string.Open_the_equipment_failure)
				.setPositiveButton(net.twoant.master.R.string.ok,
						new DialogInterface.OnClickListener() {
