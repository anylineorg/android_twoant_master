...
package net.twoant.master.ui.charge.zxing.android.book;
...
final class SearchBookContentsAdapter extends ArrayAdapter<SearchBookContentsResult> {
  ...
  SearchBookContentsAdapter(Context context, List<SearchBookContentsResult> items) {
    super(context, net.twoant.master.R.layout.search_book_contents_list_item, 0, items);
  }
  ...
  public View getView(int position, View view, ViewGroup viewGroup) {
    ...
    if (view == null) {
      ...
      listItem = (SearchBookContentsListItem) factory.inflate(
          net.twoant.master.R.layout.search_book_contents_list_item, viewGroup, false);
    } else {
