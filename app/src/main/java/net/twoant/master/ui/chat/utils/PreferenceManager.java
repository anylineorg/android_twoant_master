 ...
 */
package net.twoant.master.ui.chat.utils;
...
public class PreferenceManager {
	...
	private static String SHARED_KEY_CURRENTUSER_AVATAR_MD5 = "SHARED_KEY_CURRENTUSER_AVATAR_MD5";
	...
	public void setCurrentUserAvatarMd5(String currentUserAvatarMd5) {
		editor.putString(SHARED_KEY_CURRENTUSER_AVATAR_MD5, currentUserAvatarMd5);
		editor.apply();
	}

	public String getCurrentUserAvatarMd5() {
		return mSharedPreferences.getString(SHARED_KEY_CURRENTUSER_AVATAR_MD5, null);
	}
}
