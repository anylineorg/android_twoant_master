...
import net.twoant.master.BuildConfig;
import net.twoant.master.ui.chat.activity.RecorderVideoActivity;
import net.twoant.master.ui.chat.domain.VideoEntity;
import net.twoant.master.ui.chat.util.ImageCache;
import net.twoant.master.ui.chat.util.ImageResizer;
import net.twoant.master.ui.chat.util.Utils;
import net.twoant.master.ui.chat.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				net.twoant.master.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				net.twoant.master.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(net.twoant.master.R.drawable.em_empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(net.twoant.master.R.layout.em_image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(net.twoant.master.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(net.twoant.master.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView= LayoutInflater.from(mContext).inflate(net.twoant.master.R.layout.em_choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(net.twoant.master.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(net.twoant.master.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(net.twoant.master.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(net.twoant.master.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(net.twoant.master.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(net.twoant.master.R.drawable.em_actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(net.twoant.master.R.drawable.em_empty_photo);
