...
package net.twoant.master.ui.charge.zxing.android.encode;
...
//        displayContents = data;
        title = activity.getString(net.twoant.master.R.string.contents_text);
      }
    }
  }
...
//          displayContents = textData;
      ...
      case Contents.Type.EMAIL:
        ...
        if (emailData != null) {
          ...
          title = activity.getString(net.twoant.master.R.string.contents_email);
        }
        break;
      ...
      case Contents.Type.PHONE:
        ...
        if (phoneData != null) {
          ...
          title = activity.getString(net.twoant.master.R.string.contents_phone);
        }
        break;
      ...
      case Contents.Type.SMS:
        ...
        if (smsData != null) {
          ...
          title = activity.getString(net.twoant.master.R.string.contents_sms);
        }
        break;
      ...
      case Contents.Type.CONTACT:
        ...
        if (contactBundle != null) {
          ...
          if (!encoded[1].isEmpty()) {
            ...
            title = activity.getString(net.twoant.master.R.string.contents_contact);
          }
      ...
      case Contents.Type.LOCATION:
        ...
        if (locationBundle != null) {
          ...
          if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
            ...
            title = activity.getString(net.twoant.master.R.string.contents_location);
          }
        }
        break;
    }
