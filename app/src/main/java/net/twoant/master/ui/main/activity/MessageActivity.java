...
import net.twoant.master.ui.main.adapter.MessageAdapter;
...
public class MessageActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        mRvContentFragment.setAdapter(mMessageAdapter);
        mRvContentFragment.addItemDecoration(new RecyclerViewItemDecoration(this, net.twoant.master.R.color.dividerLineColor, 0, net.twoant.master.R.dimen.px_2));
    }
