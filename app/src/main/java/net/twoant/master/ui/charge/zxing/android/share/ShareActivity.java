...
package net.twoant.master.ui.charge.zxing.android.share;
...
public final class ShareActivity extends Activity {
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(net.twoant.master.R.layout.share);

    findViewById(net.twoant.master.R.id.share_contact_button).setOnClickListener(contactListener);
    if (Build.VERSION.SDK_INT >= 23) { // Marshmallow / 6.0
      // Can't access bookmarks in 6.0+
      findViewById(net.twoant.master.R.id.share_bookmark_button).setEnabled(false);
    } else {
      findViewById(net.twoant.master.R.id.share_bookmark_button).setOnClickListener(bookmarkListener);
    }
    findViewById(net.twoant.master.R.id.share_app_button).setOnClickListener(appListener);
    clipboardButton = findViewById(net.twoant.master.R.id.share_clipboard_button);
    clipboardButton.setOnClickListener(clipboardListener);
    findViewById(net.twoant.master.R.id.share_text_view).setOnKeyListener(textListener);
  }
