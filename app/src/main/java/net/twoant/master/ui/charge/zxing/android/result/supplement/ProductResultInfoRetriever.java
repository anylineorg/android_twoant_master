...
package net.twoant.master.ui.charge.zxing.android.result.supplement;
...
import net.twoant.master.ui.charge.zxing.android.HttpHelper;
...
final class ProductResultInfoRetriever extends SupplementalInfoRetriever {
  ...
  ProductResultInfoRetriever(TextView textView, String productID, HistoryManager historyManager, Context context) {
    ...
    this.source = context.getString(net.twoant.master.R.string.msg_google_product);
