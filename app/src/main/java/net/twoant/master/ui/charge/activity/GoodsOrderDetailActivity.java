...
public class GoodsOrderDetailActivity extends LongBaseActivity implements View.OnClickListener{
    ...
    protected int getLayoutId() {
        return net.twoant.master.R.layout.zy_activity_order_details_waitpay;
    }
    ...
    protected void subOnCreate(Bundle savedInstanceState) {
        ...
        findViewById(net.twoant.master.R.id.btn_canel_order_waitpay).setOnClickListener(this);
        findViewById(net.twoant.master.R.id.iv_back).setOnClickListener(this);
        findViewById(net.twoant.master.R.id.btn_pay_waitpay).setOnClickListener(this);
        ...
        findViewById(net.twoant.master.R.id.ll_seller_waitpay_detail);
        ...
        LongHttp(ApiConstants.WAITPAY_DETAIL, "", map, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                ...
                for (int i = 0; i < items.size(); i++){
                    View convertView2 = View.inflate(GoodsOrderDetailActivity.this, net.twoant.master.R.layout.zy_item_waitpay_orderdetail, null);
                    ...
                    convertView2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent = new Intent(GoodsOrderDetailActivity.this, GoodsDetailActivity.class);
                    ...
                    ImageLoader.getImageFromNetwork(imageView, BaseConfig.getCorrectImageUrl(items.getRow(i).getString("GOODS_IMG")),GoodsOrderDetailActivity.this);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case net.twoant.master.R.id.ll_seller_waitpay_detail:
                MerchantHomePageActivity.startActivity(GoodsOrderDetailActivity.this,shopid);
                break;
            case net.twoant.master.R.id.btn_pay_waitpay:
                WaitPayDetailActivity.startActivity(GoodsOrderDetailActivity.this,dataR.getString("SHOP_SELLER_NM"),dataR.getString("TOTAL_PRICE"),dataR.getString("VOUCHER_VAL"),dataR.getString("SELLER_SCORE"),dataR.getString("PURSE_PRICE"),dataR.getString("CASH_PRICE"),dataR.getString("ID"));
                break;
            ...
            case net.twoant.master.R.id.tv_contact_waitpay_detail:
                UserInfoUtil.startChat(null, shopid, GoodsOrderDetailActivity.this);
                break;
            case net.twoant.master.R.id.iv_back:
                finish();
                break;
            case net.twoant.master.R.id.btn_canel_order_waitpay:
                cancelOrderDialog.showDialog(true,false);
