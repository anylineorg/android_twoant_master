...
public final class HintDialogUtil {
     ...
     */
    public HintDialogUtil(Activity context) {
        mApplicationContext = AiSouAppInfoModel.getAppContext();
        mSoftReference = new SoftReference<>(context);
        this.mView = LayoutInflater.from(context).inflate(net.twoant.master.R.layout.yh_dialog_loading, null);
    ...
    public HintDialogUtil showLoading(@StringRes int msg, boolean cancelable, boolean cancelableTouchOutside) {
     ...
     */
    public HintDialogUtil showLoading(CharSequence msg, boolean cancelable, boolean cancelableTouchOutside) {
        if (!isInitialized) {
            isInitialized = true;
            initComponent();
        }
    ...
    public HintDialogUtil showLoading(@StringRes int stringRes) {
     ...
     * 不显示任何提示的加载中弹窗
     */
    public HintDialogUtil showLoading(boolean cancelable, boolean cancelableTouchOutside) {
        if (!isInitialized) {
            isInitialized = true;
            initComponent();
        }
     ...
     */
    public HintDialogUtil setOnCancelListener(final DialogInterface.OnCancelListener listener) {
        mLoadingDialog.setOnCancelListener(listener);
        return this;
    }

    public HintDialogUtil setOnDismissListener(final DialogInterface.OnDismissListener listener) {
     ...
     * @param hintInfo 错误提示
     */
    public HintDialogUtil showError(CharSequence hintInfo) {
        showError(net.twoant.master.R.drawable.dialog_hint_warm, hintInfo, true, true);
        return this;
    }

    public HintDialogUtil showError(CharSequence hintInfo, boolean cancelable, boolean cancelableTouchOutside) {
        showError(net.twoant.master.R.drawable.dialog_hint_warm, hintInfo, cancelable, cancelableTouchOutside);
        return this;
    }

    public HintDialogUtil showError(@StringRes int hintInfo) {
     ...
     * @return 当前对象
     */
    public HintDialogUtil showError(@DrawableRes int hintImageRes, CharSequence hintInfo, boolean cancelable, boolean cancelableTouchOutside) {
        if (!isInitialized) {
            isInitialized = true;
            initComponent();
        }
