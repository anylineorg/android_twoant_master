...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attrs) {
        ...
        bmpSelect = BitmapFactory.decodeResource(getResources(), net.twoant.master.R.drawable.indicator_point_select);
        bmpNomal = BitmapFactory.decodeResource(getResources(), net.twoant.master.R.drawable.indicator_point_nomal);
    }
