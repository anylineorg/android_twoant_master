...
public class CancelOrderDialog extends BaseDialog {
     ...
     * @param fillWidth
     */
    public CancelOrderDialog(Activity context, int gravity, boolean fillWidth) {
        super(context, gravity, fillWidth);
        View view = LayoutInflater.from(context).inflate(R.layout.zy_dialog_cancelorder,null);
        ...
        tvContent = (TextView) view.findViewById(R.id.tv_content_canceldialog);
