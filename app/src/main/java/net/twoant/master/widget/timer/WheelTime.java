	 ...
	 * */
{
	...
	public void setPicker(int year, int month, int day, int h, int m)
	{
		...
		// 年
		wv_year = (WheelView) view.findViewById(net.twoant.master.R.id.year);
		wv_year.setAdapter(new NumericWheelAdapter(startYear, endYear));// 设置"年"的显示数据
		wv_year.setLabel(context.getString(net.twoant.master.R.string.pickerview_year));// 添加文字
		wv_year.setCurrentItem(year - startYear);// 初始化时显示的数据

		// 月
		wv_month = (WheelView) view.findViewById(net.twoant.master.R.id.month);
		wv_month.setAdapter(new NumericWheelAdapter(1, 12, "%02d"));
		wv_month.setLabel(context.getString(net.twoant.master.R.string.pickerview_month));
		wv_month.setCurrentItem(month);

		// 日
		wv_day = (WheelView) view.findViewById(net.twoant.master.R.id.day);
		...
		wv_day.setLabel(context.getString(net.twoant.master.R.string.pickerview_day));
		wv_day.setCurrentItem(day - 1);

		wv_hours = (WheelView) view.findViewById(net.twoant.master.R.id.hour);
		wv_hours.setAdapter(new NumericWheelAdapter(0, 23, "%02d"));
		wv_hours.setLabel(context.getString(net.twoant.master.R.string.pickerview_hours));// 添加文字
		wv_hours.setCurrentItem(h);

		wv_mins = (WheelView) view.findViewById(net.twoant.master.R.id.min);
		wv_mins.setAdapter(new NumericWheelAdapter(0, 59, "%02d"));
		wv_mins.setLabel(context.getString(net.twoant.master.R.string.pickerview_minutes));// 添加文字
