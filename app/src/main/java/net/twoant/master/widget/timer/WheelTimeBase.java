	 ...
	 * */
{
	...
	private TimePickerViewBase.Type type;
	public static final int DEFULT_START_YEAR = 1990;
	public static final int DEFULT_END_YEAR = 2100;
	private int startYear = DEFULT_START_YEAR;
	private int endYear = DEFULT_END_YEAR;

	public WheelTimeBase(View view)
	{
		super();
		this.view = view;
		type = TimePickerViewBase.Type.ALL;
		setView(view);
	}

	public WheelTimeBase(View view, TimePickerViewBase.Type type)
	{
		super();
		this.view = view;
		this.type = type;
