 ...
 */
package net.twoant.master.widget.crop;
...
class HighlightView {
    ...
    private void initStyles(Context context) {
        ...
        context.getTheme().resolveAttribute(net.twoant.master.R.attr.cropImageStyle, outValue, true);
        TypedArray attributes = context.obtainStyledAttributes(outValue.resourceId, net.twoant.master.R.styleable.CropImageView);
        try {
            showThirds = attributes.getBoolean(net.twoant.master.R.styleable.CropImageView_showThirds, false);
            showCircle = attributes.getBoolean(net.twoant.master.R.styleable.CropImageView_showCircle, false);
            /*highlightColor = attributes.getColor(R.styleable.CropImageView_highlightColor,
                    DEFAULT_HIGHLIGHT_COLOR);*/
            highlightColor = ContextCompat.getColor(context, net.twoant.master.R.color.colorPrimary);
            handleMode = HandleMode.values()[attributes.getInt(net.twoant.master.R.styleable.CropImageView_showHandles, 1)];
        } finally {
            attributes.recycle();
        }
    }
