package net.twoant.master.widget.takephoto.uitl;
...
//        }
     ...
     */
    public static HintDialogUtil showProgressDialog(final Activity activity,
                                                    String... progressTitle) {
        if (activity == null || activity.isFinishing()) return null;

        return new HintDialogUtil(activity).showLoading(progressTitle[0], true, false);
    }
}
