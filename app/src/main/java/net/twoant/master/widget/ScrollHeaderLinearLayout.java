...
public class ScrollHeaderLinearLayout extends LinearLayout {
    ...
    private IOnHorizontalScroll iOnHorizontalScroll;
    ...
    public void setOnHorizontalScroll(IOnHorizontalScroll iOnHorizontalScroll) {
        this.iOnHorizontalScroll = iOnHorizontalScroll;
    }
    ...
    public ScrollHeaderLinearLayout(Context context) {
        this(context, null);
    }

    public ScrollHeaderLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrollHeaderLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        a.recycle();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (shiftX > mTouchSlop << 1 && shiftX > (shiftY * 2)) {
                    if (isHorizontalControl && iOnHorizontalScroll != null) {
                        iOnHorizontalScroll.onHorizontalScroll(mCurY, maxY);
                    }
                    //水平滑动
                    verticalScrollFlag = false;
                } else if (shiftY > mTouchSlop && (shiftY > shiftX || isHorizontalControl)) {//&& (shiftY > shiftX)
                    //垂直滑动
                    verticalScrollFlag = true;
                    if (mCurY == minY) {
                        if (onScrollListener != null) {
                            onScrollListener.onScroll(0, maxY);
                        }
                    }
                }
                /**
    ...
    public interface IOnHorizontalScroll {
        void onHorizontalScroll(int cur, int maxY);
    }
    ...
    public void setHorizontalControl(boolean isHorizontal) {
        this.isHorizontalControl = isHorizontal;
    }
    ...
    public static class HeaderScrollHelper {
        ...
        public interface ScrollableContainer {
            ...
            boolean canScrollable();
        }

        void setCurrentScrollableContainer(ScrollableContainer scrollableContainer) {
         ...
         * 实现了AdapterView,ScrollView,RecyclerView，WebView
         */
        public boolean isTop() {
            ...
            if (scrollableView == null) {
                LogUtils.e("You should call ScrollableHelper.setCurrentScrollableContainer() to set ScrollableContainer.");
                return false;
            }
        ...
        private boolean isRecyclerViewTop(RecyclerView recyclerView) {
            if (recyclerView != null) {
                ...
                if (layoutManager instanceof LinearLayoutManager) {
                    ...
                    if (childAt == null || (firstVisibleItemPosition == 0 && mCurrentScrollableContainer.canScrollable())) {
                        return true;
                    }
                } else if (layoutManager instanceof StaggeredGridLayoutManager) {
                    int[] firstVisibleItemPosition = ((StaggeredGridLayoutManager) layoutManager).findFirstCompletelyVisibleItemPositions(null);
                    View childAt = recyclerView.getChildAt(0);
                    for (int i : firstVisibleItemPosition)
                        if (childAt == null || (firstVisibleItemPosition[i] == 0)) {
                            return true;
                        }
                }
            }
